                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-end mt-2">
                                <div class="icon icon-shape bg-gradient-primary text-center rounded-circle">
                                    <i class="fa-solid fa-plug-circle-bolt text-lg opacity-10" aria-hidden="true"  style="color: white"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-end mt-2">
                                <div class="icon icon-shape bg-gradient-warning shadow-danger text-center rounded-circle">
                                    <i class="fa-solid fa-bolt text-lg opacity-10" aria-hidden="true" style="color: orange"></i>
